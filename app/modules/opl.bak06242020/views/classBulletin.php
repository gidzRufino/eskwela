        ...
        <div class="card card-widget " id="card_<?php echo $pd->task_auto_id ?>">
            <div class="card-header">
                <div class="user-block">
                    ...
                    <span onclick="document.location='<?php echo site_url('opl/viewTaskDetails/'.$pd->task_code.'/'.$grade_level.'/'.$section_id.'/'.$subject_id); ?>'" style="cursor:pointer;" class="username"><?php echo $pd->task_title . ' - ' . $pd->tt_type ?></span>
