...
<body style="overflow-y: hidden;">
   ...
   <!--<input style="position:absolute;" onchange="scanRFID(this.value)" onload="self.focus();"  class="" id="rfid" placeholder="Rfid" type="text">-->
      <form id="scan_form" name="scan_form">
         <input style="position:absolute; left:-1000px" onload="self.focus();" onblur="this.focus();"  class="" id="rfid" name="rfid" placeholder="Rfid" type="text">
      </form>
...
$('#rfid').change(function(){
   ...
   if(previousId == ID){
      ...
      $.ajax({
         ...
         data: $("#scan_form").serialize()+'&csrf_test_name='+$.cookie('csrf_cookie_name'),
