...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->MultiCell(210, 5, 'Learner Permanent Record for Junior High School (SF10-JHS)', '', 'C', 0, 0, '', '', true);
        $this->Ln();
...
$sRec = Modules::run('sf10/getSPRrec', $stID, $year);
$pdf->SetFont('helvetica', 'B', 10);
$pdf->SetFillColor(191, 191, 191);
...
$aRec = Modules::run('sf10/getAcademicRecords', $stID, $year, $sRec->grade_level_id);
