...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        if ($this->page == 1):
            ...
            $this->MultiCell(210, 5, 'Learners Permanent Record for Junior High School (SF10-JHS)', '', 'C', 0, 0, '', '', true);
            $this->Ln();
...
$pdf = new MYPDF('P', 'mm', array('250', '365'), true, 'UTF-8', false);
...
$pdf->MultiCell(24, 5, "", 'B', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
