...
// blank rows and columns
        ...
        foreach($gradeLevel as $level)
        {
            ...
            switch ($level->grade_id):
                case 8:
                    $totalMaleBoSY = $g7MaleBoSy;
                    $totalFemaleBoSY = $g7FemaleBoSy;
                ...
                break;
                case 9:
                    $totalMaleBoSY = $g8MaleBoSy;
                    $totalFemaleBoSY = $g8FemaleBoSy;
                ...
                break;
                case 10:
                    $totalMaleBoSY = $g9MaleBoSy;
                    $totalFemaleBoSY = $g9FemaleBoSy;
                ...
                case 11:
                    ...
                    $totalMaleBoSY = $g10MaleBoSy;
                    $totalFemaleBoSY = $g10FemaleBoSy;
                    $MaleDrpPm = 0;
                    $FemaleDrpPm = 0;
                    $MaleDrpThis = 0;
                    $FemaleDrpThis = 0;
            ...
            if($c>1):
                ...
                //registered learners
                $pdf->MultiCell(7, 5, $totalMaleBoSY,1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
                $pdf->MultiCell(7, 5, $totalFemaleBoSY,1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
                $pdf->MultiCell(7, 5, $totalMaleBoSY+$totalFemaleBoSY,1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
...
Cumulative as of End of the Month',1, 'C', 0, 0, '', '', true, 0, false, true, 15, 'M');
        ...
        $maleStud += $totalMaleBoSY;
        $femaleStud += $totalFemaleBoSY;
