    ...
    <tbody id="itemBody">
       ...
       //print_r($charges);
        ...
        foreach($charges as $c): 
            ...
            $payments = Modules::run('finance/finance_ccsa/getTransactionByItemId', $student->uid, NULL,$school_year, $c->item_id);
            ...
            if(!$c->is_fused):
                ?>
                 ...
                 <?php
                     ...
                     if($isFused==1):
                        $fpayments = Modules::run('finance/getTransaction', $student->uid, 0, $school_year);
                        //print_r($fpayments);
                        if($fpayments):
