	...
	public function Header() {
		// Logo
                ...
                if($this->page==1):
                    ...
                    $this->Image($image_file, 145, 3, 18, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
                    
                    $image_file = K_PATH_IMAGES.'/uccp.jpg';
                    $this->Image($image_file, 238, 3, 15, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
...
foreach ($students->result() as $st):
    ...
    foreach ($loadedSubject as $subject):
        $grade = Modules::run('college/gradingsystem/getFinalGrade',$st->st_id, segment_4, $subject->s_id, segment_5, segment_6,0);
        ...
        $pdf->MultiCell(45, 5, ($grade->gsa_grade!=0 && $grade->gsa_grade!=9?number_format($grade->gsa_grade,2):''),1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
