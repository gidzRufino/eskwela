<div data-role="page" id="recordScore">
  ...
  <div style="margin-bottom: 30px;">
        ...
        <select onchange="getQuiz(this.value)" name="searchAssessDate"  id="searchAssessDate" required>
...
<script type="text/javascript" >
    $(document).ready(function() {
        $('#searchAssessDate').change(function(){
           getQuiz($(this).val())
    ...
    if(document.getElementById('recordStudent').value=='Search Student'){
        ...
        alert('Please Enter Raw Score');
            ...
            $.ajax({
                   type: "POST",
                   url: url,
                   data: $("#recordScoreForm").serialize(), // serializes the form's elements.
                   success: function(data)
                   {
