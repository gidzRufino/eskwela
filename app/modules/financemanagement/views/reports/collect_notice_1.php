        ...
        <tr>
            <td style="padding: 15px;">
                <table style="width: 400px;border-collapse:collapse; margin-left: 50px;">
                        ...
                        <td colspan="6" style="text-align:center;">
                            <table cellspacing="0" cellpadding="1" style="border: 1px solid black; width: 400px;">
                                ...
                                <tr>
                                    ...
                                    <th style="text-align:center;border: 1px solid gray;">Balance Due</th>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <th colspan="6" style="text-align:center;"> B A L A N C E  &nbsp;&nbsp; D U E &nbsp;&nbsp; D E T A I L S </th>
                    </tr>
                    <tr>
                        <td colspan="6" style="text-align:center;">
                            <table cellspacing="0" cellpadding="1" style="border: 1px solid black; width: 400px;">
                                <tr>
                                    ...
                                    <th style="text-align:center;border: 1px solid gray;font-size: 10px;">Balance Due</th>
                                </tr>
                                '.$rolling.'
                                <tr>
