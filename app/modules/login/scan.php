...
<h2 class="oswald" style="position: absolute; margin-left: 37%; z-index: 2000; color:lime; font-size: 150px; font-weight:bold; margin-top:22px;" id="clock"></h2>
...
<div class="clearfix row scan" style="margin: 0 auto 0"  >
        ...
        <div class="col-md-4">
            <img class="col-lg-12" id="avatar" style="margin-top:50px; margin-left:20px; width:98%;" src="<?php echo base_url();?>images/avatar/noImage.png" />
        </div>
        <div class="col-md-7" style="margin-left:60px; margin-top:22px;">
                <div class="col-lg-3 pull-right">
                    <h2 class="oswald pull-right " style="color:white; font-size: 50px; font-weight:normal; margin-top:20px;"><?php echo date('m/d/y');?></h2>
        ...
        <div class="row-fluid" style=" margin-top:200px;">
          <div class="span10">
              <h2 id="lastname" class="oswald" style="color:white; font-size: 90px; font-weight:bold;">Last Name</h2>
              <h2 id="firstname" class="oswald" style="color:white; font-size: 110px; font-weight:bold; margin-top:-35px;">First Name</h2>
            ...
            <!-- <div class="row-fluid" style=" margin-top:200px;">
                <div class="span10">
                    <h2 id="lastname" class="oswald" style="color:white; font-size: 55px; font-weight:normal;">Last Name</h2>
                    <h2 id="firstname" class="oswald" style="color:white; font-size: 55px; font-weight:normal; margin-top:20px;">First Name</h2>
                    <h3 style="color:white; font-family: Helvetica; font-size: 35px; font-weight:normal; margin-top:20px;"><span id="user_id"  style="color:green;">ID #:</span></h3>
                </div>
            </div> -->
