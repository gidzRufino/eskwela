<div data-role="page" id="createQuiz"  >
    ...
    <div data-role="content">
        <div class="ui-field-contain">
            <div class="controls">
                <input name="inputBdate" type="text" data-date-format="mm-dd-yy"  value="<?php echo date("m/d/Y"); ?>" id="inputBdate" placeholder="Search for Date" required>
            </div>        
            ...
            <input type="text" id="selectAssessmentCategoryValue" />
...
function saveAssessment()
{
     var url = "<?php echo base_url().'gradingsystem/saveAssessment' ?>"; // the script where you handle the form input.
        ...
        $.ajax({
               type: "POST",
               url: url,
               data: 'title='+title+"&date="+date+"&section_id="+section_id+"&subject_id="+subject_id+'&faculty_id='+faculty_id+"&no_items="+no_items+"&quiz_cat="+quiz_cat+"&term="+term, // serializes the form's elements.
