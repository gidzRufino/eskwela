...
foreach($subject_ids as $s){
    ...
    $pdf->MultiCell(12, 5, ($trans1->trans_info==""?"":$trans1->trans_info),1, 'C', 0, 0, '', '', true, 0, false, true,5, 'M'); 
    $pdf->MultiCell(12, 5, ($trans2->trans_info==""?"":$trans2->trans_info),1, 'C', 0, 0, '', '', true, 0, false, true,5, 'M');
    $pdf->MultiCell(12, 5, ($trans3->trans_info==""?"":$trans3->trans_info),1, 'C', 0, 0, '', '', true, 0, false, true,5, 'M');
    $pdf->MultiCell(12, 5, ($trans4->trans_info==""?"":$trans4->trans_info),1, 'C', 0, 0, '', '', true, 0, false, true,5, 'M');
    $pdf->MultiCell(24 , 5, '',1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
    $pdf->MultiCell(15, 5, '',1, 'C', 0, 0, '', '', true, 0, false, true,5, 'M');
...
//end of Grading Sheets
    ...
    $pdf->MultiCell(12, 5, '',1, 'C', 0, 0, '', '', true, 0, false, true,5, 'M');
    $pdf->MultiCell(12, 5, '',1, 'C', 0, 0, '', '', true, 0, false, true,5, 'M');
    $pdf->MultiCell(24 , 5, ($frg->row()->final_rating==0?'':($generalFinal==""?'':$generalFinal)),1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
    $pdf->MultiCell(15, 5, '',1, 'C', 0, 0, '', '', true, 0, false, true,5, 'M');
...
for($d=1;$d<=11;$d++){
    ...
    if($pdays>0):
        $pdf->MultiCell(8, 5, $pdays,1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');  
    else:
...
for($d=1;$d<=11;$d++){
    ...
    if($pdays>0):
        $pdf->MultiCell(8, 5, $totalDaysInAMonth-$pdays,1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');  
    else:
        $pdf->MultiCell(8, 5, 0 ,1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M'); 
    endif; 
