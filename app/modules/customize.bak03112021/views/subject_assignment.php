...
<script type="text/javascript">
    ...
    function delAssignSub(id) {
        $.confirm({
            title: 'Confirmation Alert!',
            content: 'Are you sure you want to delete this Subject assign?',
            buttons: {
                confirm: function () {
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo base_url() . 'academic/delAssignSub' ?>',
                    ...
                    $('#viewList').modal('hide');
                    $.alert('Subject Assigned Deleted Successfuly!');
                    location.reload();
                },
                cancel: function () {
                    $.alert('Canceled!');
