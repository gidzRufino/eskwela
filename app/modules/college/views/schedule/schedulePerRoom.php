                ...
                <tbody>    
                   ...
                   <?php 
                       foreach ($time_range as $key => $value):  
                           $day1 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 1, $room, $sem, $school_year);
                           $day2 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 2, $room, $sem, $school_year);
                           $day3 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 3, $room, $sem, $school_year);
                           $day4 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 4, $room, $sem, $school_year);
                           $day5 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 5, $room, $sem, $school_year);
                           $day6 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 6, $room, $sem, $school_year);
                           $day7 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 7, $room, $sem, $school_year);
                                        ...
                                        foreach ($day1 as $d1):
                                            if(strtotime($value)== strtotime($d1->t_from)):
                                                ?>
                                                    ...
                                                    <?php echo $d1->sub_code.' - Rm. '.$d1->room.'<br />'.$d1->short_code.'-'.$d1->section.'<br />'; ?>
                                                <?php 
    ...
    function searchSubject(value)
     {
        ...
        var url = "<?php echo base_url().'college/schedule/loadSubject/'?>"+value+'/'+sem; // the script where you handle the form input.
