        ...
        <div class="panel panel-green">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <a style="color:white;" href="#importCsv" data-toggle="modal"  id="uploadAssessment" class="btn btn-success pull-right" >
                       <i class="fa fa-upload fa-2x"></i>
                   </a>
                    <button id="deleteAssessment" alt="" onclick="deleteAssessment()" class="btn btn-danger hide pull-right"  >
                        <i class="fa fa-trash fa-2x"></i>
                    </button> 
                   <a id="editAssessment" class="btn btn-info hide pull-right" data-toggle="modal" href="#editAssessForm" >
...
<script type="text/javascript" >
    ...
    function getQuiz(id)
    {
        ...
        var url = "<?php echo base_url().'gradingsystem/getAssessmentDetails/'?>"+id+'/'+school_year ;
          $.ajax({
           type: "GET",
           url: url,
