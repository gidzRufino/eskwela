...
$students = Modules::run('registrar/getStudentForCard', segment_7,segment_6, segment_4, $sy);
        ...
        foreach($subject_ids as $sub):
          $singleSub = Modules::run('academic/getSpecificSubjects', $sub->sub_id);
            ...
            if($singleSub->parent_subject==11):
                $finalRating += $finalGrade->row()->final_rating;
            endif;
        endforeach;    
        $mp =1;
        foreach($subject_ids as $sub):
            ...
            if($singleSub->parent_subject==11):
                ...
                if($m==4):
                    ...
                    if($finalRating!=""):
                        ...
                        $pdf->MultiCell(33, 5, $finalRating/4,1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'T');
                ...
                if($singleSub->short_code!=""):
                    $pdf->Ln();
                    $pdf->SetX($x+2);
                    $pdf->MultiCell(33, 5, $singleSub->short_code.$m,1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'T');
