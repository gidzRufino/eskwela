...
foreach($students->result() as $mStudent):
    ...
    $pdf->Ln(-10);
    $pdf->SetX($x);
    $pdf->MultiCell(20, 5, '',0, 'L', 0, 0, '', '', true, 0, false, true, 30, 'T');
    $pdf->MultiCell(80, 5, $settings->set_school_address,0, 'C', 0, 0, '', '', true, 0, false, true, 30, 'T');
    $pdf->Ln(7);
    ...
    $pdf->MultiCell(25, 5, ucfirst($term),'B', 'L', 0, 0, '', '', true, 0, false, true, 5, 'T');
