...
<tr class="main"> 
    ...
    <?php
        ...
        {
        ?>
        <td style="cursor:pointer;" onclick="getIndividualAssessment('<?php echo $student->st_id ?>',<?php echo $subject_id ?>,<?php echo $k->code ?>, <?php echo $term ?>)" class="values" >
         <?php
...
?>    
    ...
    <td id="<?php echo $student->st_id ?>_btn_validate" >
        ...
        <?php 
            $isGradeValidated = Modules::run('gradingsystem/isGradeValidated', $student->st_id, $subject_id, $term);
            if(!$isGradeValidated):
