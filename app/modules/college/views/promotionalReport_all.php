...
foreach ($course as $c):
    ...
    if ($c->course != ""):
        if ($c->dept_id < 4):
            ...
            $pdf->Ln();
            $x++;
            $students = Modules::run('college/getStudentPerCourse', $c->course_id, segment_4, segment_5);
            ...
            foreach ($students->result() as $st):
                ...
                if ($st->status):
                    ...
                    foreach ($loadedSubject as $subject):
                        ...
                        $grade = Modules::run('college/gradingsystem/getFinalGrade', $st->st_id, $c->course_id, $subject->s_id, segment_4, segment_5, 4);
                        switch (TRUE):
