        ...
        ?>
            <tr style="height:15px !important;">
               ...
               <?php echo strtoupper($st->firstname.' '.$st->lastname) ?>  
                ...
                <?php
                   $qz = Modules::run('gradingsystem/getRawScore', $st->user_id, $getAssessment->assess_id);
                   $score = $qz->row();
                ?>
                <td  class="col-xs-4" id="score_<?php echo $st->user_id ?>"  name="<?php echo strtoupper($st->firstname.' '.$st->lastname) ?>" user_id="<?php echo $st->user_id ?>" score="<?php if($qz->num_rows()>0){ echo $score->raw_score;} ?>">
