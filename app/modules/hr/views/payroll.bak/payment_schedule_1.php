            ...
            <table id="timeTable" class="table table-hover">
                ...
                <?php
                 foreach ($time_settings as $ts):
                     ?>
                <tr>
                    <td><?php echo $ts->day_name ?></td>
                    <td id="time_in_td_<?php echo $ts->set_id ?>"><?php echo $ts->time_in ?></td>
                    <td id="time_out_td_<?php echo $ts->set_id ?>"><?php echo $ts->time_out ?></td>
                    <td><i id="timeBtn_<?php echo $ts->set_id; ?>" class="btn fa fa-pencil-square-o" onclick="editTime('<?php echo $ts->set_id; ?>','<?php echo $ts->time_in; ?>','<?php echo $ts->time_out; ?>' )"></i></td>
                </tr>
                <?php
                 endforeach;
                 ?>
