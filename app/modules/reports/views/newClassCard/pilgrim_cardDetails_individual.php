...
$subject_ids = Modules::run('academic/getSpecificSubjectPerlevel', $gradeLevel);

$mStudent = Modules::run('registrar/getSingleStudent', base64_decode($st_id), $this->session->userdata('school_year'));
