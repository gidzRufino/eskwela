       ...
       public function events()
  {
     if(!$this->session->userdata('is_logged_in')){
        ...
        foreach ($calendar as $cal) {
          ...
          $curl = '';
          $cstart = $cal_date.' 08:00';
          // $cstart = date('Y-m-d H:i', $cstart);
          $cend = $cal_date.' 17:00';
          // $cend = date('Y-m-d H:i', $cend);
          $data[] = array(
             'id' 	=> $cal->esk_calendar_events_code,
             'title'	=> $cal->event,
             'start' => $cstart,
             'end'	=> $cend,
             'backgroundColor' 	=> $cbg,
    ...
    public function getPost($id) {
        $postDetails = $this->opl_model->getPost($id);
        return $postDetails;
    }
    ...
    public function index() {
        ...
        $data = array(
            'isClass' => FALSE,
            'post' => $this->getPost($this->session->username),
            'subjectDetails' => [],
