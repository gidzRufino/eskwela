...
class MYPDF extends Pdf {
	...
	public function Header() {
                ...
                $this->SetTitle('Billing Statement');
        }
...
//    
   // if($a <= 4):
        ...
        $financeDetails = json_decode(Modules::run('finance/finance_reports/getLCFinanceDetails', $student, $month));
        $pdf->SetXY($x,$y);
        ...
        $pdf->SetX($x);
        $pdf->SetFont('helvetica', 'N', 10);
        $pdf->MultiCell(45, 5, 'OUTSTANDING BALANCE :',0, 'R', 0, 0, '', '', true, 0, false, true, 5, 'T');
        $pdf->SetFont('helvetica', 'B', 11);
