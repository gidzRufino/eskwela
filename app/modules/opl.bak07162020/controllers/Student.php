...
class Student extends MX_Controller {
    ...
    function searchTasks(){
        ...
        echo $this->load->view('students/tr', $discData);
    }
    ...
    public function index()
    {
        ...
        $class = $details->grade_id."-".$details->section_id;
        $data = array(
            'isClass'       => FALSE,
            'subjectDetails'=> NULL,
            'post'          =>  $this->student_model->getPost($class),
    ...
    public function classBulletin($subject = NULL, $school_year = NULL, $task = NULL)
    {
        ...
        switch ($task):
            ...
            case 'List':
                    ...
                    $data['tasks'] = $this->opl_model->getTask($this->session->details->grade_id, $this->session->details->section_id, $subject, $school_year);
