    ...
    <div class="panel-body" style="padding:0;">
        <table class="table table-bordered text-center">
            ...
            foreach ($gradelevel as $gl):
                if($gl->grade_id!=18):
                    $male = Modules::run('registrar/getStudentsByGradeLevel',$gl->grade_id, null, 'Male', NULL);
                    $female = Modules::run('registrar/getStudentsByGradeLevel',$gl->grade_id, null, 'Female', NULL);
