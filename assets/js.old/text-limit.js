...
!function( $ ){
  ...
  $.fn.limit = function ( option ) {
    return this.each(function () {
      var $this = $(this)
        , data = $this.data('txtlimit')
        , options = typeof option == 'object' && option
      if (!data) $this.data('txtlimit', (data = new Limit(this, options)))
  ...
  * ================== */
  ...
  $(function () {
    $('body').on('focus.txtlimit.data-api', '[data-provide="txtlimit"]', function (e) {
      var $this = $(this)
      if ($this.data('txtlimit')) return
      e.preventDefault()
