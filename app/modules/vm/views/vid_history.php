         ...
         <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-primary">
               <div class="panel-heading text-center">
                  ...
                  <?php 
                     $card_info = $pinfo->firstname.' '.$pinfo->middlename;
                     $cstat = $pinfo->status;
                  ...
                  <b><span style="color: yellow;"> <?php echo $card_info ?></span> Card History</b>
                  ...
                  <div class="row">
                     <div class="col-md-5">
                        <div class="input-group">
                           <span class="input-group-addon" id="">Card Description</span>
                           <input type="text" class="form-control" placeholder="<?php echo $card_info ?>" aria-describedby="basic-addon1">
                           <span class="input-group-addon" id=""><a href="">edit</a></span>
                        </div>
                     </div>
                     <div class="col-md-5 pull-right">
                        <div class="input-group">
                           <span class="input-group-addon" id="">Card Status</span>
                           ...
                           <table id="inv_table" class="tablesorter table table-bordered">
                              <thead class="bg-primary">
                                 <tr>
                                    ...
                                    <th style="text-align:center;"><b>Visitor Accounts</b></th>
                              ...
                              <tbody>
                                 ...
                                 <?php
                                    foreach ($vinfo as $vn) {
                                       ...
                                       $vname = $vn->va_lastname.', '.$vn->va_firstname;
                                       $vdate = $vn->log_date;
                                       $vlogin = $vn->log_in;
                                       $vlogout = $vn->log_out;
                                 ...
                                 <tr>
                                    ...
                                    <td style="text-align:center; vertical-align: middle; font-weight: bold;"><a href="<?php echo base_url('vm/vm_status/'.base64_encode($vn->va_id)) ?>"><?php echo $vname ?></td>
