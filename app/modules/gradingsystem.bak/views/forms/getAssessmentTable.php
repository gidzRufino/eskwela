<div id="assessWrapper" class="hide">
    <div class="pull-left">
      ...
      <div class="pull-right">
        ...
        <input type="hidden" id="sub_id" value="<?php echo $getAssessment->subject ?>" />
      </div>
</div>
...
<div class="row">
    <div class="span12"> 
        <?php
            $Students = Modules::run('registrar/getAllStudentsByLevel', $getAssessment->grade_id, $getAssessment->section_id, $school_year);   
               ?>
...
{   
    ...
    { if (e.which == 13) { 
            ...
            if(altLockBtnLabel=='relock'){
              var dataString = 'rawScore='+newContent + "&recordStudent="+ID+"&searchDate="+searchDate+"&quizCode="+quizCode+"&total="+numberOfItems+"&original="+OriginalContent+"&subject_id="+sub_id+"&relock=1"+'&csrf_test_name='+$.cookie('csrf_cookie_name')  
            }else{
              var dataString = 'rawScore='+newContent + "&recordStudent="+ID+"&searchDate="+searchDate+"&quizCode="+quizCode+"&total="+numberOfItems+"&original="+OriginalContent+"&subject_id="+sub_id+"&relock=0"+'&csrf_test_name='+$.cookie('csrf_cookie_name')  
            }
