        ...
        <div class="col-md-12">
          <div class="panel panel-info" style="margin-bottom: 0px;">
            <div class="panel-heading">
              ...
              <select class="pull-right" onclick="getSY()" tabindex="-1" id="search_sy" style="width: 225px; margin-top: -3px;">
                  ...
                  <div class="col-md-12">
                    <table class="table table-condensed table-bordered">
                      ...
                      <tr class="info">
                        ...
                        <td style="text-align:center;"><a href="<?php echo base_url('financemanagement/pay_confirm/'.base64_encode($st->trans_id).'/'.base64_encode($sy_now).'/'.base64_encode($st->stud_id)) ?>"><?php echo $st->ref_number ?> | <?php echo $st->trans_id ?></td>
