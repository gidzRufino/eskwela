...
?>
    ...
    <input type="hidden" name="transferDateFrom" id="transferDateFrom"  value="<?php echo $transaction->t_date ?>" class="form-control" />
    <input type="hidden" name="transferSemesterTo" id="transferSemesterTo"  value="<?php echo $semester ?>" class="form-control" />
    </div>
...
<script type="text/javascript">
    ...
    function processFundTransfer()
    {
        ...
        var url = '<?php echo base_url().'college/finance/processFundTransfer/' ?>';
        $.ajax({
            type: "POST",
            url: url,
