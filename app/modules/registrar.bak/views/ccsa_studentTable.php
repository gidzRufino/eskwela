<script type="text/javascript">
    ...
    function search(value)
    {
        ...
        {
            var url = '<?php echo base_url() . 'search/getStudentByGradeLevel/' ?>' + option + '/' + value + '/' + sy;
        } else {
    ...
    function stud_type(sttype, userID, schoolYear) {
        var url = '<?php echo base_url() . 'registrar/update_student_status' ?>';

        $.ajax({
            type: "POST",
            url: url,
            dataType: 'json',
            data: {st_type: sttype, st_userid: userID, school_year: schoolYear, csrf_test_name: $.cookie('csrf_cookie_name')},
