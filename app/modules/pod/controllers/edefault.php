               ...
               <tbody>
                  ...
                  <tr class="<?php echo $bg ?>">
                     ...
                     <td class="text-center"><button type="button" class="btn btn-info btn-sm" id="rem<?php echo $tt->l_id ?>" onclick="add_remarks(this.id)" style="text-align:center; margin-right: 5px;"><i class="fa fa-pencil"></i></button>
                        <input type="hidden" id="inu<? echo $tt->l_id ?>" name="inu<? echo $tt->l_id ?>" value="<?php echo $tt->lastname.', '.$tt->firstname ?>" />
                        <input type="hidden" id="igu<? echo $tt->l_id ?>" name="igu<? echo $tt->l_id ?>" value="<?php echo $tt->level ?>" />
                        <input type="hidden" id="isu<? echo $tt->l_id ?>" name="isu<? echo $tt->l_id ?>" value="<?php echo $tt->section ?>" />
                        <input type="hidden" id="idu<? echo $tt->l_id ?>" name="idu<? echo $tt->l_id ?>" value="Adviser Neimo" />
                        <input type="hidden" id="iru<? echo $tt->l_id ?>" name="iru<? echo $tt->l_id ?>" value="<?php echo $tt->l_remarks ?>" />
                        <input type="hidden" id="cnt<? echo $ttcount ?>" name="cnt<? echo $ttcount ?>" value="<?php echo base64_encode($tt->l_st_id) ?>" />
                     </td>
                  </tr>
