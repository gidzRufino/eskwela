...
class Opl extends MX_Controller {
    ...
    {
        if($this->session->isOplAdmin || $this->session->position_id == 97):
    ...
    public function events()
  {
    ...
    public function getPost($id, $grade_id = NULL, $section_id = NULL) {
    ...
    function getUnitDetails($code, $school_year = NULL) {
    ...
    public function addDiscussion($code = NULL) {
        ...
        if($hasUpload == 1):
            ...
            $config['upload_path'] = UPLOADPATH.$school_year.DIRECTORY_SEPARATOR.'faculty'.DIRECTORY_SEPARATOR.$this->session->username.DIRECTORY_SEPARATOR.$subGrSec[0].DIRECTORY_SEPARATOR.'discussion';
            if(!is_dir($config['upload_path'].'/')):
                mkdir($config['upload_path'],0777,TRUE);
            endif;
    ...
    public function discussionBoard($school_year = NULL, $employee_id = NULL, $grade_level = NULL, $section = NULL, $subject = NULL) {
        ...
        if(!$this->session->isOplAdmin):
            $data['discussionDetails'] = Modules::run('opl/opl_variables/getDiscussionList', ($employee_id=='NULL'||$employee_id==NULL?$this->session->username:$employee_id));
        else:
