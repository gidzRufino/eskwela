...
function getBGBLetterGrade($grade)
{
    $plg = Modules::run('gradingsystem/getBGBLetterGrade', $grade);
        ...
        foreach($subject_ids as $sub):
          $singleSub = Modules::run('academic/getSpecificSubjects', $sub->sub_id);
            ...
            if($singleSub->subject_id==20):
                    $pdf->MultiCell(33, 5, getBGBLetterGrade($finalGrade->row()->final_rating),1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'T');
            else:    
