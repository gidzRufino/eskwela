...
function getBHRate() {
    ...
    function viewTeacherInfo($id)
    {
        ...
        $data['basicInfo'] =  $this->academic_model->getBasicInfo($id);
    ...
    {
        $assignment = $this->academic_model->mySubjects($user_id, $school_year);
        return $assignment;
    }
...
function getSubjectsPerGradeLvl($gid) {
    ...
    function getSpecificSubjectPerlevel($grade_id=NULL)
    {
        $subject = $this->academic_model->getSubjectPerLevel($grade_id);
        return $subject;
        //print_r($subject);
    }
