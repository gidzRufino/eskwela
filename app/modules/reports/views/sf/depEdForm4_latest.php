...
{
    $adviser = Modules::run('academic/getAdvisory', '', $sec->section_id);
    ...
    $dailyAttendance = Modules::run('attendance/getMonthlyAttendanceSummary', segment_4, $sec->section_id, $this->session->userdata('attend_auto'), $year);
    ...
    if($maleEoSY!=0):
        ...
        //attendance daily
        $pdf->MultiCell(7, 5, round($dailyAttendance->ave_male_total),1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
        $pdf->MultiCell(7, 5, round($dailyAttendance->ave_female_total),1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
        $pdf->MultiCell(7, 5, round($totalAverageDailyAttendance),1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
        
        //attendance monthly
        $pdf->MultiCell(7, 5, round($dailyAttendance->percent_male,2),1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
        $pdf->MultiCell(7, 5, round($dailyAttendance->percent_female, 2),1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
        $pdf->MultiCell(7, 5, round($sumMonthlyPercentage, 2),1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
        
        //Drop out
        $maleDrpPm = Modules::run('registrar/getStudentStatus', 3, 'Male', segment_4, $sec->section_id, $school_year,0);
        $femaleDrpPm = Modules::run('registrar/getStudentStatus', 3, 'Female', segment_4, $sec->section_id, $school_year,0);
        ...
        $maleDrpthis = Modules::run('registrar/getStudentStatus', 3, 'Male', segment_4, $sec->section_id, $school_year, 1);
        $femaleDrpthis = Modules::run('registrar/getStudentStatus', 3, 'Female', segment_4, $sec->section_id, $school_year, 1);
        ...
        // transfered out
        $maleToPm = Modules::run('registrar/getStudentStatus', 1, 'Male', segment_4, $sec->section_id, $school_year, 0);
        $femaleToPm = Modules::run('registrar/getStudentStatus', 1, 'Female', segment_4, $sec->section_id, $school_year, 0);
        ...
        $maleToThis = Modules::run('registrar/getStudentStatus', 1, 'Male', segment_4, $sec->section_id, $school_year, 1);
        $femaleToThis = Modules::run('registrar/getStudentStatus', 1, 'Female', segment_4, $sec->section_id, $school_year, 1);
        ...
        //Transferred In
        $maleTiPm = Modules::run('registrar/getStudentStatus', 2, 'Male', segment_4, $sec->section_id, $school_year, 0);
        $femaleTiPm = Modules::run('registrar/getStudentStatus', 2, 'Female', segment_4, $sec->section_id, $school_year, 0);
        ...
        $maleTiThis = Modules::run('registrar/getStudentStatus', 2, 'Male', segment_4, $sec->section_id, $school_year, 1);
        $femaleTiThis = Modules::run('registrar/getStudentStatus', 2, 'Female', segment_4, $sec->section_id, $school_year, 1);
...
// blank rows and columns
        ...
        foreach($gradeLevel as $level)
        {
            ...
            if($c>1):
                ...
                $dailyAttendanceSum = Modules::run('attendance/getMonthlyAttendanceSummaryPerLevel', segment_4, $level->grade_id, $this->session->userdata('attend_auto'), $year);
