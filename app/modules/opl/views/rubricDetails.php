                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-lg-12 float-left" id="rubricCriteriaWrapper">
                        <table class="table table-stripped table-hover">
                            <tr><th class="col-lg-1">Criteria</th><th class="text-center">Percentage</th><th class="text-center" id="thScale" colspan="<?php echo $rubricDetails->ri_scale ?>">SCALE</th></tr>
                            <tbody id="criteriaBody">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $s->rd_scale ?></td>
                                    <?php endforeach; ?>
                                </tr>
                                <?php endforeach; ?>
