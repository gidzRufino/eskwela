...
<script type="text/javascript">
    ...
    function saveRO()
    {
        ...
        $.ajax({
            ...
            url: url,
            dataType: 'json',
            data: "grade_id=" + grade_id + '&section_id=' + section_id + '&st_id=' + st_id + '&str_id=' + str_id + '&school_year=' + school_year + '&csrf_test_name=' + $.cookie('csrf_cookie_name'), // serializes the form's elements.
