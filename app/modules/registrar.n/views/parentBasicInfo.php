...
<script type='text/javascript'>
    ...
    function editParentInfo()
    {
        ...
        $.ajax({
            ...
            url: url,
            //dataType: 'json',
            data: 'lastname=' + $('#lastname').val() + '&firstname=' + $('#firstname').val() + '&middlename=' + $('#middlename').val() + '&parent_id=' + $('#rowid').val() + '&sy=' + <?php echo $school_year ?> +'&pos='+ $('#pos').val()+'&csrf_test_name=' + $.cookie('csrf_cookie_name'), // serializes the form's elements.
