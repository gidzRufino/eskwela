<div id="cashRegister" class="modal fade" style="width:70%; margin:30px auto; " tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
     <div class="panel panel-primary">
        <div class="panel-heading clearfix">
            ...
            <div class="col-md-6">
                <div style="margin-top:10px;"  class="form-group pull-right col-md-6">
                    <label>Cash/Cheque</label>
                ...
                <div id="chequeWrapper" class="form-group pull-right col-md-12" style="display: none;">
             ...
             <div class="col-lg-8">
                 <div class="bg-info clearfix">
                     <div class="form-group col-lg-4">
                        <label>OR #</label>
                        <input type="text" id="refNumber" value="<?php echo ($FinSettings->print_receipts?$series->or_current+1:'') ?>"  class="form-control"  placeholder="OR Number" />
                    </div>
                     <div class="form-group col-lg-4">
                  ...
                  <option value="0">Select Item</option> 
                    <?php 
                           foreach ($fin_items as $i)
                             {   
                       ?>                        
                  <option id="<?php echo $i->item_id; ?>_desc" value="<?php echo $i->item_id; ?>"><?php echo strtoupper($i->item_description); ?></option>
                    <?php }?>
                </select>   
            </div>
            <div class="form-group">
    ...
    <div class="panel panel-green" style='width:100%;'>
        ...
        <div class="panel-body">
            ...
            <?php if($FinSettings->print_receipts):?>
                <div class="pull-left" >
                    <input type="checkbox" checked="checked" id="printOtherOR" /> PRINT Official Receipt
                </div>
...
<script type="text/javascript">
    ...
    function saveTransaction()
    {
        ...
        var inputCheque = $('#inputCheque').val();
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url() . 'college/finance/saveOtherTransaction' ?>',
            dataType: 'json',
            data: {
...
//                });
                ...
                <?php if($FinSettings->print_receipts):?>
                    ...
                    if($('#printOtherOR').is(':checked')){
                       // alert('hey')
                        var url = '<?php echo base_url('college/finance/printOtherOR/')?>'+response.accountNumber+'/'+or_num+'/'+(transType==0?'Cash':'Cheque')+'/'+$('#ptAmountTendered').val()+ '/' + sy + '/' + sem;;
