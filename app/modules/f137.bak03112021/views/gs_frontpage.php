...
$pdf->SetFont('helvetica', '', 7);
$pdf->MultiCell(45, 5, "I CERTIFY that this is a true record of", 'L', 'L', 0, 0, '10', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(60, 5, strtoupper($student->sprp_firstname) . ' ' . ($student->sprp_middlename != '' ? substr($student->sprp_middlename, 0, 1) . '.' : '') . ' ' . strtoupper($student->sprp_lastname) . ' ' . ($student->sprp_extname != '' ? strtoupper($student->sprp_extname) : ''), 'B', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
...
$pdf->MultiCell(57, 5, "and that he/she is eligible for admission to Grade", '', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(25, 5, $grd_level->level, 'B', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(3, 5, "", 'R', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->Ln();

$pdf->SetFont('helvetica', '', 7);
$pdf->MultiCell(23, 5, "Name of School:", 'L', 'L', 0, 0, '10', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(63, 5, $settings->set_school_name, 'B', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');

$pdf->MultiCell(15, 5, "School ID:", '', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(30, 5, $settings->school_id, 'B', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');

$pdf->MultiCell(35, 5, "Last School Year Attended:", '', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(60, 5, "", 'B', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(4, 5, "", 'R', 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->Ln();
...
$pdf->Output('SF10-' . $userName->lastname . ', ' . $userName->firstname . '  --  ' . $student->sprp_lastname . '.pdf', 'I');
