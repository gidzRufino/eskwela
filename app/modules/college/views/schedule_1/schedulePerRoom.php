                ...
                <tbody>    
                   ...
                   <?php 
                       foreach ($time_range as $key => $value):  
                           $day1 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 1, $room, $sem);
                           $day2 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 2, $room, $sem);
                           $day3 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 3, $room, $sem);
                           $day4 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 4, $room, $sem);
                           $day5 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 5, $room, $sem);
                           $day6 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 6, $room, $sem);
                           $day7 = Modules::run('college/schedule/getSingleTimeSchedulePerRoom', 7, $room, $sem);
