<section id="discussDetails" class="col-lg-6 col-xs-12 float-left">
    <div class="card card-blue card-outline">
        <div class="card-header">
            ...
            <i class="fa fa-file-pdf fa-xs float-right mr-2 text-primary" style="cursor:pointer;" discussion-id="<?php echo $discussionDetails->dis_sys_code; ?>" onclick="toPDF(this)"></i>
            <i class="fa fa-edit fa-xs float-right mr-2 text-success" style="cursor:pointer;" discussion-id="<?php echo $discussionDetails->dis_sys_code; ?>" discussion-title="<?php echo $discussionDetails->dis_title; ?>" discussion-details='<?php echo $discussionDetails->dis_details; ?>' discussion-link="<?php echo $discussionDetails->dis_unit_id; ?>" discussion-date="<?php echo date('Y-m-d', strtotime($discussionDetails->dis_start_date)); ?>" discussion-time="<?php echo date('H:i', strtotime($discussionDetails->dis_start_date)); ?>" onclick="showEditDiscussion(this)"></i>
        </div>
        <div class="card-body">
