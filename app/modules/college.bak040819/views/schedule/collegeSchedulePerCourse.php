...
<div class="col-lg-12">
    <div style="margin-top:10px;">
        <div class="form-group pull-right">
              <select onclick="getSchedulePerCourse('<?php echo $this->uri->segment(4) ?>', '<?php echo $this->uri->segment(5) ?>', this.value )" tabindex="-1" id="inputSem" name="inputSem" style="width:100%" >
                ...
                <tbody>    
                   ...
                   <?php 
                       foreach ($time_range as $key => $value):  
                           $day1 = Modules::run('college/schedule/getSingleTimeSchedulePerCourse', 1, $course_id, $year, strtotime($value), $this->uri->segment(6));
                           $day2 = Modules::run('college/schedule/getSingleTimeSchedulePerCourse', 2, $course_id, $year, strtotime($value), $this->uri->segment(6));
                           $day3 = Modules::run('college/schedule/getSingleTimeSchedulePerCourse', 3, $course_id, $year, strtotime($value), $this->uri->segment(6));
                           $day4 = Modules::run('college/schedule/getSingleTimeSchedulePerCourse', 4, $course_id, $year, strtotime($value), $this->uri->segment(6));
                           $day5 = Modules::run('college/schedule/getSingleTimeSchedulePerCourse', 5, $course_id, $year, strtotime($value), $this->uri->segment(6));
                           $day6 = Modules::run('college/schedule/getSingleTimeSchedulePerCourse', 6, $course_id, $year, strtotime($value), $this->uri->segment(6));
                           $day7 = Modules::run('college/schedule/getSingleTimeSchedulePerCourse', 7, $course_id, $year, strtotime($value), $this->uri->segment(6));
        ...
        <div style="min-height: 200px; max-height: 300px;overflow-y: scroll; " class="panel-body  no-padding">
            <?php foreach($course as $c): 
                    for($i=1;$i<=4;$i++):
                        ...
                        endswitch;
                ?>
            <div onclick="document.location='<?php echo base_url('college/schedule/perCourse/'.$c->course_id.'/'.$i.'/'.$this->uri->segment(6)) ?>'"  class='btn btn-default alert alert-warning no-margin' style="border-radius: 0; padding-top:5px; padding-bottom: 5px; width: 100%;">
                <div class="notify">
...
<script type="text/javascript">
   ...
   function getSchedulePerCourse(seg4, seg5, sem)
   {
       var url = '<?php echo base_url('college/schedule/perCourse/') ?>'+seg4+'/'+seg5+'/'+sem
