...
//variables
$subject = Modules::run('college/subjectmanagement/getSubjectPerId',segment_4);
$section = Modules::run('college/subjectmanagement/getSectionById', segment_5);
$scheds = Modules::run('college/schedule/getSchedulePerSection', segment_5); 
...
$pdf->SetFont('helvetica', 'N', 10);
$pdf->MultiCell(50, 5, $instructor->lastname.', '.$instructor->firstname.' ',0, 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->SetFont('helvetica', 'B', 10);
...
$pdf->MultiCell(30, 5, 'Course',1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
...
foreach($students as $st):
   ...
   switch ($st->year_level):
    ...
    $pdf->MultiCell(30, 5, strtoupper($st->short_code),1, 'L', 0, 0, '', '', true, 0, false, true, 5, 'M');
