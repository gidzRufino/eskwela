...
<script type="text/javascript">
   ...
   function loadDetails(st_id, sy)
   {
        if(sy==="<?php echo $this->session->school_year ?>")
        {
           sy = "";
        }    
       var url = '<?php echo base_url().'finance/loadAccountDetails/' ?>'+st_id+'/'+sy;
            $.ajax({
               type: "GET",
               url: url,
               ...
               success: function(data)
               {
                    ...
                    document.location = '<?php echo base_url().'finance/accounts/' ?>'+st_id+'/'+sy;
               }
             });
   ...
   function search(value)
      {
          ...
          var url = '<?php echo base_url().'search/searchStudentAccountsK12/' ?>'+value+'/'+school_year;
            $.ajax({
               type: "GET",
               url: url,
