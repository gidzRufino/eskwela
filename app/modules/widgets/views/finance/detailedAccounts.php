...
foreach ($accountz as $az):
    ...
    //-------------------------------------------------------------------------->>>>>>
      ...
      ?>
        <div class='col-lg-12 panel mobile-panel-name pointer'>
            <div class="col-lg-8">
                  <a href="<?php echo base_url('financemanagement/msa/'.base64_encode($stud_id).'/'.base64_encode($sy_id)) ?>">
                    <h4 style="margin:5px 0 5px; color:black;"><?php echo $my_name; ?></h4>
                  </a>
            </div>
            <div class="col-lg-3 pull-right">
                <h5 class="no-margin pull-right" style="color:black;"><?php echo $tot_balance_due ?></h5>
            </div>
        </div>
      ...
      <?php
          ...
          // } //forloop
          // } // if($az_level==$our_level)
endforeach; // foreach ($accountz as $az) 
