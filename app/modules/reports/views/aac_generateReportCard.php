<div class="well col-lg-12">
    ...
    <div class="col-lg-6">
        <h3 style="color:black; margin:3px 0;">
            <span id="name">
            <?php echo $student->firstname." ". $student->lastname ?></span> ss</h3>
        ...
        <table class="table table-striped">
            ...
            <tr>
              ...
              <td class="text-center">
                ...
                <select onclick="submitConduct('<?php echo $student->uid?>', this.value, <?php echo $term ?>,<?php echo $sy ?>)" tabindex="-1" style="width:200px;">
                  <?php
                     $conduct = Modules::run('reports/getaconduct', $student->uid);
                     if($conduct->num_rows()>0):
                        switch ($term) {
                           case 1:
                             $cterm = $conduct->row()->cd_first;
                              break;
                           case 2:
                              $cterm = $conduct->row()->cd_second;
                              break;
                           case 3:
                              $cterm = $conduct->row()->cd_third;
                              break;
                           case 4:
                              $cterm = $conduct->row()->cd_fourth;
                              break;
                        }
                     ...
                     <option <?php echo $fifth ?> value="5">C - Commendable</option>
                     <option <?php echo $fourth ?> value="4">VS - Very Satisfactory</option>
                     <option <?php echo $three ?> value="3">S - Satisfactory</option>
                     <option <?php echo $two ?> value="2">NI - Needs Improvement</option>
                     <option <?php echo $one ?> value="1">U - Unsatisfactory</option>
               </select>
              </td>
            </tr>
        </table>
...
<script type="text/javascript">
    ...
    function submitConduct(st_id, rating, grading, school_year)
    {
      var url = "<?php echo base_url().'reports/saveconduct/'?>"+st_id+'/'+rating+'/'+grading+'/'+school_year;
        $.ajax({
         type: "GET",
         url: url,
         data: 'qcode='+grading, // serializes the form's elements.
