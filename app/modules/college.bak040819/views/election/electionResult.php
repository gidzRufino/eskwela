...
<script type="text/javascript">
    ...
    function getLiveResult()
    {
            ...
            var url = '<?php echo base_url().'college/election/getLiveElectionResult/' ?>';
             $.ajax({
                   type: "GET",
                   url: url,
