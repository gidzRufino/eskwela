...
<div class="col-lg-12">
    <div class="col-lg-12">
        ...
        <button class="btn btn-default btn-xs pull-right" title="Print Grade Sheet" ><i class="fa fa-print fa-2x"></i></button>
    </div>
    <div class="col-lg-10">
        <div class="col-lg-6">
            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                    <?php 
                        ...
                        $subject = Modules::run('college/subjectmanagement/getSubjectPerId', $subject_id);
