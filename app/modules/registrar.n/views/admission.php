    ...
    $(document).ready(function () {
        ...
        $("#saveAdmission").click(function () {
            ...
            if (fName.length < 1 || lName.length < 1 || grade == 0 || section == 0 || inputSY == 0) {
                ...
                if (grade == 0) {
                    $('#inputGrade').after('<br><span class="error">Grade Level is required</span>');
                }
                if (section == 0) {
                    $('#inputSection').after('<br><span class="error">Section is required</span>');
                }
                if (inputSY == 0) {
                    $('#inputSY').after('<br><span class="error">School Year is required</span>');
                }
            } else {
