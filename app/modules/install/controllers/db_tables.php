...
/**
 * Description of db_tables
 *
 * @author genesisrufino
 */
class db_tables extends MX_Controller { 
    
    
    function esk_calendar_events_category($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_calendar_events_category` (
            `cat_id` int(11) NOT NULL,
            `events_category` varchar(55) NOT NULL
          ) ENGINE=InnoDB DEFAULT CHARSET=utf8;";
        
        $query2 = "INSERT INTO `esk_calendar_events_category` (`cat_id`, `events_category`) VALUES
            (1, 'School'),
            (2, 'Department'),
            (3, 'Personal'),
            (4, 'Legal Holiday');";
        $query3 = "ALTER TABLE `esk_calendar_events_category`
    ...
    function esk_cities($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_cities` (
                `id` int(11) NOT NULL,
                `mun_city` varchar(300) NOT NULL,
                `province_id` int(11) NOT NULL
              ) ENGINE=InnoDB DEFAULT CHARSET=utf8;";
        
        $query2 = "INSERT INTO `esk_cities` (`id`, `mun_city`, `province_id`) VALUES
                (1, 'Bangued', 1),
                (2, 'Boliney', 1),
                (3, 'Bucay', 1),
                (4, 'Bucloc', 1),
                ...
                (1635, 'Titay', 80),
                (1636, 'Tungawan', 80);";
        $query3 = "ALTER TABLE `esk_cities`
                ADD PRIMARY KEY (`id`),
                ADD KEY `province_id` (`province_id`)";
        $query4 = "ALTER TABLE `esk_cities`
    ...
    function esk_calendar_events($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_calendar_events` (
    ...
    function esk_calendar($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_calendar` (
    ...
    function esk_barangay($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_barangay` (
    ...
    function esk_attendance_summary($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_attendance_summary` (
    ...
    function esk_attendance_sheet($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_attendance_sheet` (
    ...
    function esk_attendance_log_book($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_attendance_log_book` (
    ...
    function esk_advisory($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_advisory` (
    ...
    function esk_admission_remarks($year)
    {
        $this->db = $this->eskwela->db($year);
        $query = "CREATE TABLE `esk_admission_remarks` (
