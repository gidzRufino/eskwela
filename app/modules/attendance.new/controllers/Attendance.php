...
//        endif;
    ...
    function saveMonthlyAttendanceSummary($month=NULL, $section_id = NULL, $maleTotal=NULL, $femaleTotal=NULL, $maleAve=NULL, $femaleAve=NULL, $percentMale=NULL, $percentFemale=NULL, $attend_auto=NULL, $school_year=NULL)
    {
        ...
        if($summaryExist):
            ...
            $this->attendance_model->updateMonthlyAttendanceSummary($month, $section_id, $data, $attend_auto, $school_year);
        else:
            $data = array(
