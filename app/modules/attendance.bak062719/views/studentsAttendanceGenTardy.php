<h3 style="text-align: center; margin-top: 10px">Generate Attendance Tardy</h3>
...
<script type="text/javascript">
    ...
    function getIndividualMonthlyAttedance(st_id, month, year, school_year, id,m, sprid)
    {
        ...
        records = records + 1;
        var url = '<?php echo base_url('attendance/attendance_reports/getIndivualTardy/') ?>'+st_id+'/'+month+'/'+year+'/'+school_year+'/'+sprid;
        $.ajax({
               type: "POST",
               url: url,
