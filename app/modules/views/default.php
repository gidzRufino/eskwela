<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header" style="margin:0">Grading System
        <div class="col-md-3 pull-right">
         ...
         <div class="col-md-3 pull-right" id="month" style="width:230px;">
                <div class="controls" id="addTerm">
                  <select style="font-size:16px;"  tabindex="-1" id="inputTerm" style="width:200px" class="span2">
                      <?php
                         $first = "";
                         $second = "";
                         $third = "";
        ...
        <?php if(!Modules::run('main/isMobile')): ?>
            <button onclick="document.location='<?php echo base_url().'reports/export/' ?>'+$('#section_id').val()+'/'+$('#subject_id').val()+'/'+$('#selectAssessmentCategory1').val()" id="q_template" class="hide btn btn-info btn-sm pull-right" style="margin-right: 10px; margin-top:5px;">Download Eskwela Quiz Template</button>
        <?php endif; ?>
        </h1>
...
<div class="row" style="margin-top:10px;">
    <div style="cursor: pointer;" onmouseover="document.getElementById('formController').value='createQuiz'" onclick="$('#createQuiz').fadeIn(),$('#recordScore').hide(),$('#classRecord').hide()"  class="col-md-4">
    ...
    <div class="col-md-4"  style="cursor: pointer;"  onmouseover="document.getElementById('formController').value='recordScore'" onclick="$('#createQuiz').hide(), $('#recordScore').fadeIn(),$('#classRecord').hide(), enterRawScore()" >
    ...
    <div class="col-md-4" style="cursor: pointer;" onmouseover="document.getElementById('formController').value='classRecord'" onclick="$('#createQuiz').hide(), $('#recordScore').hide(),$('#classRecord').fadeIn(), getClassRecord()"  >
            ...
            if(section_id!=""){
                var url = "<?php echo base_url().'gradingsystem/getAssessment/'?>" ;
                    $.ajax({
                     type: "POST",
                     url: url,
                     data: 'section_id='+section_id+"&subject_id="+subject_id+"&term="+term+'&csrf_test_name='+$.cookie('csrf_cookie_name'), // serializes the form's elements.
                     success: function(data)
                     {
