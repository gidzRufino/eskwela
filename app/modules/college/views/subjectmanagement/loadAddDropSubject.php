<div class="col-lg-12">
    <table class="table table-stripped">
        ...
        <tr>
            ...
            <td class="text-center">
                <button class="btn btn-xs btn-danger" onclick="addDropSubject('<?php echo $s->s_id ?>','<?php echo ($s->pre_req=="None"?'None':$s->pre_req) ?>','<?php echo $s->sec_id ?>')"><i class="fa fa-plus"></i></button>
            </td>
