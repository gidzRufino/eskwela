...
<div id="addSubject"  style="width:30%; margin: 0 auto;"  class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="panel panel-primary" style='width:100%;'>
        ...
        <div class="panel-body">
            <input value="" style="width:100%;" class="" multiple="multiple" name="inputSubject" type="text" id="addedSubjects" placeholder="Select Subject" /> 
            <div style='margin:5px 0;'>
                <a href='#' id='' data-dismiss='modal' onclick='saveSubjects()' style='margin-right:10px;' class='btn btn-xs btn-success pull-left'>Save</a>
                    ...
                    <div class="form-group">
                        <div class="panel panel-green" style="min-height: 100px; overflow-y: auto;">
                            ...
                            <div class="panel-body">
                                <div class="col-lg-3">
                                    <label>First</label>
                                    <input onclick="if ($('#inputSubject').val() == '') {
                                                alert('Please Select Subject First!')
                                            }" type="text" class="form-control text-center" id="first" value="" required/>
                                </div>
                                <div class="col-lg-3">
                                    <label>Second</label>
                            ...
                            <div class="panel-body">
                                <div id="firstSemWrapper" style="display: none;">
                                    <div class="col-lg-4">
                                        ...
                                        <input onclick="if ($('#inputSubject').val() == '') {
                                                    alert('Please Select Subject First!')
                                                }" type="text" class="form-control text-center" id="firstSH" value="" required/>
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Second</label>
