    ...
    <div class="panel panel-green">
        <div class="panel-heading clearfix">
            ...
            <div class="form-group col-lg-3 pull-right">
                <select tabindex="-1" id="inputCSY" name="inputCSY" style="width:200px; font-size: 15px; color:black;">
                ...
                <select tabindex="-1" id="inputCSubject" name="inputCSubject" class="col-lg-12 no-padding">
                   ...
                   <?php 
                         foreach ($collegeSubjects as $cs)
                          { 
                         ?>                        
                       <option value="<?php echo $cs->s_id; ?>"><?php echo $cs->s_desc_title ?></option>
                       <?php }?>
               </select>
              </div>
    ...
    function addSubjectPerCourse()
     {
        ...
        var url = "<?php echo base_url().'coursemanagement/addSubjectPerCourse'?>"; // the script where you handle the form input.
