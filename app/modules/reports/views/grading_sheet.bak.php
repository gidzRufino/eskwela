...
foreach($male->result() as $s){
    ...
    if($assessment->first>0){$first = $assessment->first;}else{$first="";}
    if($assessment->second>0){$second = $assessment->second;}else{$second="";}
    if($assessment->third>0){$third = $assessment->third;}else{$third="";}
    if($assessment->fourth>0){$fourth = $assessment->fourth;}else{$fourth="";}
    $generalAverage = ($first+$second+$third+$fourth)/4;
    $pdf->MultiCell(15, 3, $first,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
    $pdf->MultiCell(15, 3, $second,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
    $pdf->MultiCell(15, 3, $third,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
    $pdf->MultiCell(15, 3, $fourth,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
    $pdf->MultiCell(15, 3, $generalAverage,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
