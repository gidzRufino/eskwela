        ...
        <div class="panel-body">
            <div id="dbWrapper">
                ...
                <div class="form-group input-group">
                    ...
                    <input class="form-control"  id="dbName" placeholder="DB Name or School's Short Name" type="text" >
                </div>
                <div class="form-group input-group">
...
<script type="text/javascript">
    ...
    function checkDB()
    {
        ...
        var url = "<?php echo base_url().'install/doInstall/'?>";
        $.ajax({
            type: "POST",
            url: url,
            beforeSend: function() { 
                $('#footerWrapper').prepend('<h6 id="loadPrepend">Loading Database...Please Wait...</h6>')
            },
            dataType:'json',
            data: 'name='+name+"&pass="+pass+"&dbName="+dbName+"&year="+year+'&csrf_test_name='+$.cookie('csrf_cookie_name'), // serializes the form's elements.
    ...
    function saveInfo()
    {
        ...
        $.ajax({
            ...
            url: url,
            //dataType:'json',
            data: 'data='+JSON.stringify(data)+'&name='+name+"&pass="+pass+"&school_year="+year+"&dbName="+dbName+'&csrf_test_name='+$.cookie('csrf_cookie_name'), // serializes the form's elements.
            success: function(data)
            {   
                   alert(data);
                   location.reload();
