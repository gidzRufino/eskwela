        ...
        <div style="min-height: 150px; max-height: 350px;overflow-y: scroll; " class="panel-body  no-padding">
            <?php foreach($course as $c): 
                    ...
                    for($i=1;$i<=4;$i++):
                        ...
                        endswitch;
                ?>
            <div onclick="document.location='<?php echo base_url('college/schedule/perCourse/'.$c->course_id.'/'.$i) ?>'" class='btn btn-default alert alert-link no-margin' style="border-radius: 0; padding-top:5px; padding-bottom: 5px; width: 100%;">
                <div class="notify">
