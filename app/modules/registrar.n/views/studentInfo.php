...
<div class="row">
    <div class="well col-lg-12" id="profBody">
        ...
        <div class="col-lg-6">
            ...
            <h3 style="color:black; margin:3px 0;"><?php echo $students->level; ?> - <span id="a_section"><?php echo $students->section; ?></span><span id="a_strand"><?php echo ' - ' . $strand->short_code ?></span>
...
<?php } ?>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span id="a_f_occupation"><?php echo strtoupper($f->occupation); ?></span>
...
if ($f->f_office_name != ""):echo strtoupper($f->f_office_name);
else: echo "[empty]";
endif;
?></span>
                        ...
                        <i id="saveF_office_nameBtn" onclick="updateProfile('<?php echo base64_encode('parent_id') ?>', '<?php echo base64_encode('esk_profile_parents') ?>',<?php echo $students->p_id ?>, 'f_office_name', $('#f_office_name').val(), 'f_office_name'), $('#a_f_office_name').show(), $('#f_office_name').hide(), $('#editF_office_nameBtn').show(), $('#saveF_office_nameBtn').hide(), $('#closeF_office_nameBtn').hide()" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span title="double click to edit" id="a_fmobile" ><?php
                           if ($f->cd_mobile != ""):echo $f->cd_mobile;
                           else: echo "[empty]";
                           endif;
                           ?></span>
                        ...
                        <i id="saveFMobileBtn" onclick="updateProfile('<?php echo base64_encode('contact_id') ?>', '<?php echo base64_encode('esk_profile_contact_details') ?>', '<?php echo ($f->fid) ?>', 'cd_mobile', $('#fmobile').val(), 'fmobile');
...
<?php } ?>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span id="a_m_occupation"><?php echo strtoupper($m->occupation); ?></span>
                        ...
                        <i id="saveMOccBtn" onclick="updateOccupation($('#m_occupation').val(), '<?php echo $user_id; ?>', 'm'), $('#a_m_occupation').show(), $('#m_occupation').hide(), $('#editMOccBtn').show(), $('#saveMOccBtn').hide(), $('#closeMOccBtn').hide()" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span title="double click to edit" id="a_mmobile" ><?php
                            if ($m->cd_mobile != ""):echo $m->cd_mobile;
                            else: echo "[empty]";
                            endif;
?></span>
...
<script type="text/javascript">
    ...
    function editAddressInfo()
    {
        ...
        $.ajax({
            ...
            url: url,
            //dataType: 'json',
            data: 'street=' + $('#street').val() + '&user_id=' + $('#address_user_id').val() + '&barangay=' + $('#barangay').val() + '&city=' + $('#city').val() + '&province=' + $('#inputPID').val() + '&address_id=' + $('#address_id').val() + '&zip_code=' + $('#zip_code').val() + '&sy=' + <?php echo segment_4 ?> + '&csrf_test_name=' + $.cookie('csrf_cookie_name'), // serializes the form's elements.
            success: function (data)
            {
    ...
    function editBasicInfo()
    {
        ...
        $.ajax({
            ...
            url: url,
            //dataType: 'json',
            data: 'lastname=' + $('#lastname').val() + '&firstname=' + $('#firstname').val() + '&middlename=' + $('#middlename').val() + '&rowid=' + $('#rowid').val() + '&user_id=' + $('#st_user_id').val() + '&pos=' + $('#pos').val() + '&sy=' + <?php echo segment_4 ?> + '&csrf_test_name=' + $.cookie('csrf_cookie_name'), // serializes the form's elements.
            success: function (data)
            {
                $('#' + name_id).html(data);
                location.reload;
