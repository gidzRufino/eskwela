...
$data['pdf'] = $pdf;
$data['x'] = 0;
$data['copy'] = '[ Registrar\'s Copy ]';
$data['school_year'] = $school_year;
$this->load->view('pecit_printStudyLoadDetails', $data);

$pdf->Ln(20);
$pdf->SetX(0);
//$pdf->MultiCell(286, 0, '','T', 'C', 0, 0, '', '', true, 0, false, true, 0, 'M');

$data['st_id'] = $st_id;
$data['pdf'] = $pdf;
$data['x'] = 190;
$data['copy'] = '[ Student\'s Copy ]';
$this->load->view('pecit_printStudyLoadDetails', $data);
