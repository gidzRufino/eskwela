  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editTasksForm" class="row">
            ...
            <div class="col-xs-12 col-lg-6 pull-left">
                ...
                <select id="taskGrade" name="taskGrade" class="form-control" onchange="fetchLesson(this.value)">
					...
					<?php
						$getSubjects = Modules::run('opl/opl_widgets/mySubject', $this->session->username, NULL);
            ...
            <div class="form-group col-xs-12 col-lg-6">
                ...
                <input class="form-control" type="file" id="userfile" id="" onchange="uploadFile(this)">
            </div>
