<div class="card card-widget">
    ...
    <div class="card-body">
        ...
        <button class="btn btn-primary btn-sm float-right" sub-id="<?php echo $this->session->details->grade_level_id."-".$this->session->details->section_id; ?>" onclick="submitQuickPost(this)">POST</button>
    </div>
</div>
<div id="quickPost">
