...
<div class="row">
   <div class="col-lg-12 page-header">
      ...
      <div class="col-md-3 pull-right">
         <button onclick="#" id="" class="btn btn-info pull-right" style="margin-right: 10px; margin-top:5px;" disabled>Employee</button>
...
<div class="row">
   ...
   <div class="col-md-7">
      ...
      <h4><a href="<?php echo base_url('pod/esearch') ?>" class="pull-right" style="margin: 0 20px 0 20px;">Search Employee</a></h4>
   </div>
</div>
<div class="row">
   <div class="col-lg-8" style="margin-top: 10px;">
      <div class="panel panel-primary">
         <div class="panel-heading">
            ...
            <button type="button" class="btn btn-default btn-sm pull-right" onclick="location.reload()" style="text-align:center; margin: -5px -5px 0 0;">Refresh <i class="fa fa-refresh"></i></button>
         </div>
         <div class="panel-body">
            <table id="student_table" class="table table-bordered table-condensed table-sm tablesorter">
               <thead>
                  <tr class="bg-primary">
                     <th rowspan="2" style="padding-bottom: 3%;" class="text-center" >Employee Name</th>
                     <th rowspan="2" style="padding-bottom: 3%;" class="text-center">Position</th>
               ...
               <tbody>
                  ...
                  <tr class="<?php echo $bg ?>">
                     ...
                     <td class="text-center"><?php echo $tx.''.$tt->position.''.$txe ?></td>
                     ...
                     <td class="text-center"><button type="button" class="btn btn-info btn-sm" id="rem<?php echo $tt->l_id ?>" onclick="add_remarks(this.id)" style="text-align:center; margin-right: 5px;"><i class="fa fa-pencil"></i></button>
                        ...
                        <input type="hidden" id="igu<?php echo $tt->l_id ?>" name="igu<?php echo $tt->l_id ?>" value="<?php echo $tt->position ?>" />
   ...
   <div class="col-lg-4" style="margin-top: 10px;">
      <div class="panel panel-danger">
         ...
         <div class="panel-body">
            <table id="student_table" class="table table-hover table-bordered table-condensed table-sm tablesorter">
               <thead>
                  <tr class="bg-primary">
...
<script type="text/javascript">
   ...
   {
      document.location = '<?php echo base_url('pod/esearch/') ?>' + stid;
   }
   ...
   function re_calc()
   {
      ...
      for (i = tcount; i >= 1; i--) {
         ...
         var url = '<?php echo base_url().'pod/ecalculate' ?>';
         $.ajax({
            type: "POST",
            url: url,
            dataType:'json',
  ...
  function add_remarks(id)
  {
   ...
   document.getElementById("he2").innerHTML = '<b>Position: </b><span style="color:#BB0000;">'+ rgrade + '</span>';
