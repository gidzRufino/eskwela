        ...
        <div class="col-lg-12">
            <div style="width:70%; margin: 20px auto" id="subject_body">
                ...
                <div style="margin-top:20px;" class="input-group col-lg-5 pull-right">
                    <input onkeyup="searchSubject(this.value)"  type="text"id="searchSubject" class="form-control col-lg-2" placeholder="Search Subject" />                    
...
<script type="text/javascript"> 
    ...
    {
          var url = '<?php echo base_url().'college/subjectmanagement/searchSubjectResult/' ?>'+value;
            $.ajax({
               type: "GET",
               url: url,
               beforeSend: function() {
    ...
    function selectSubject(sub_id, code)
    {
        ...
        $('#Code').val(code);
         ...
         var url = "<?php echo base_url().'college/subjectmanagement/getSectionPerSubject/'?>"+sub_id;
             $.ajax({
                   type: "POST",
                   url: url,
...
//        alert($('#editCollege').serialize())
        $.ajax({
               type: "POST",
               url: url,
               data: $('#editCollege').serialize()+'&csrf_test_name='+$.cookie('csrf_cookie_name')                                                                                                                                                                                                                                                            , // serializes the form's elements.
               success: function(data)
               {
                   alert(data)
                   location.reload();
...
//        });
      ...
      // alert(allVal)
        ...
        $.ajax({
               type: "POST",
               url: url,
               data: $('#addCollege').serialize()+'&csrf_test_name='+$.cookie('csrf_cookie_name')                                                                                                                                                                                                                                                            , // serializes the form's elements.
               success: function(data)
               {
                   alert(data)
                   location.reload();
