...
$g7 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 8, $sy));
$g8 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 9, $sy));
$g9 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 10, $sy));
if(segment_3==2014):
    $g10 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 18, $sy));    
else:    
    $g10 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 11, $sy));    
endif;

$g11 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 12, $sy));
$g12 = json_decode(Modules::run('gradingsystem/getPromotionalReport', 13, $sy));
