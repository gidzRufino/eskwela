            ...
            <div class="tab-content col-lg-12 no-padding">
                ...
                ?>
                        <div class="col-lg-12 tab-pane <?php echo $active; ?>"  data-toggle="context" data-target="#<?php echo $menu ?>" style="padding-top: 15px;" id="<?php echo $dept->level_dept_id ?>">
                            ...
                            ?>  
                                <ol id="college" class="col-lg-12">
                                    <?php 
                                        foreach($courses as $c):
                                    ?>
                                    <li id="<?php echo $c->course_id ?>_li" onmouseover="$('#sec_name').val('<?php echo $c->course ?>'), $('#course_id').val('<?php echo $c->course_id ?>')"><a href="#" onclick="$('#collegeCourseSubject').modal('show'), loadSubject('<?php echo $c->course ?>')"><?php echo $c->course ?></a></li>
                                    <?php
                                        endforeach;
                                    ?>
                                </ol>
...
<div id="otherMenu">
    <ul class="dropdown-menu" role="menu">
       ...
       <li class="pointer"><a tabindex="-1"><i class="fa fa-edit fa-fw"></i>Rename Section</a></li>
       <li class="divider"></li>
...
<div id="collegeMenu">
    <ul class="dropdown-menu" role="menu">
       <li  class="pointer"><a href="#" onclick="getAdd('Course')"><i class="fa fa-plus-square fa-fw"></i>Add Course</a></li>
       <li class="pointer"><a tabindex="-1"><i class="fa fa-edit fa-fw"></i>Rename Course</a></li>
       <li class="divider"></li>
