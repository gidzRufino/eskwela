            ...
            foreach ($section as $sec):
                ...
                <tr id="tr_<?php echo $sec->sec_id ?>">
                    ...
                    <td class="text-center">
                        <button title="Edit Section" onclick="editSection('<?php echo $sec->sec_id ?>')" class="btn btn-xs btn-success"><i class="fa fa-pencil-square fa-fw"></i></button>
...
<script type="text/javascript">
    ...
    function editSection(sec_id)
    {
            ...
            {   if(e.which == 13) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: 'sec_id='+sec_id+'&value='+newContent+'&csrf_test_name='+$.cookie('csrf_cookie_name') ,
                        cache: false,
    ...
    function deleteSection(sec_id)
    {
       ...
       if(confirmDelete)
       {
           var url = "<?php echo base_url().'college/subjectmanagement/deleteSection/' ?>"+sec_id; // the script where you handle the form input.
            $.ajax({
                   type: "GET",
                   url: url,
