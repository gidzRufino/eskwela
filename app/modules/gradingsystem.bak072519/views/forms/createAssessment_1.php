<div id="createQuiz" style="display: none;">
    <div class="panel panel-primary">
        ...
        <?php
            ...
            <div class="col-lg-6">
                <select name="inputDll" id="inputDll" style="width:100%; height:50px;" required>
                      <option>Select DLL Link</option> 
                      <?php foreach ($getAllDLL->result() as $dll) { ?>
                         <option value="<?php echo $dll->dll_id ?>"><?php echo $dll->lesson ?></option> 
                      <?php }?>
