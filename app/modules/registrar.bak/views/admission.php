    ...
    <div>
        ...
        <div class="panel panel-green">
            ...
            <div class="panel-body">
                ...
                <div id="k-12">
                    <div class="col-lg-12">
                        <div class="form-group col-lg-3">
                            <label>First Name<span class="reqindicators">*</span></label>
                        ...
                        <div class="form-group  col-lg-3">
                            <label>Last Name<span class="reqindicators">*</span></label>
                            <?php
                            $inputLastName = array(
                                'name' => 'inputLastName',
                                'id' => 'inputLastName',
                        ...
                        <div class="form-group col-lg-3">
                            <label>Grade  Level<span class="reqindicators">*</span></label><br />
                            <select style="height:35px; width: auto; display: inherit" name="inputGrade" onclick="selectSection(this.value), setId(this.value)" id="inputGrade" required>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group col-lg-3">
                            <label>Section<span class="reqindicators">*</span></label><br />
                            <div id="AddedSection">
                                <select class="form-control" name="inputSection" id="inputSection" required>
                        ...
                        <div class="form-group col-lg-3">
                            <label>Date of Birth<span class="reqindicators">*</span></label>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group col-lg-3">
                            <label class="control-label" for="inputGender">Gender<span class="reqindicators">*</span></label>
                            <div class="controls">
                                <select class='form-control' name="inputGender" id="inputGender" style="width:225px;" required>
                ...
                <div id="collegeAd" style="display: none">
        ...
        <div class="panel panel-primary ">
            ...
            <div class="panel-body ">
                <div class="col-lg-12">
                    ...
                    <div class="form-group col-lg-3">
                        <label class="control-label" for="inputAddress">Barangay:<span class="reqindicators">*</span></label>
                    ...
                    <div class="form-group col-lg-3">
                        <label class="control-label" for="inputCity">City / Municipality:<span class="reqindicators">*</span></label>
                    ...
                    <div class="form-group col-lg-3">
                        <label class="control-label" for="inputState">Province:<span class="reqindicators">*</span></label>
                    ...
                    <div class="form-group col-lg-3">
                        <label class="control-label" for="inputPostal">Postal Code:<span class="reqindicators">*</span></label>
    ...
    $(document).ready(function () {
        ...
        $("#saveAdmission").click(function () {
          clearEmptyMessage();
            ...
            var inputSY = $('#inputSY').val();

      			var proceed = 1;

      			if (fName.length < 1 || lName.length < 1 || grade == 0 || section == 0 || inputSY == 0) {
      					proceed = 0;
      				if (fName.length < 1) {
      					$('#inputFirstName').after('<small class="error errmess">First Name is required</small>');
      				}
      				if (lName.length < 1) {
      					$('#inputLastName').after('<small class="error errmess">Last Name is required</small>');
      				}
      				if (grade == 0) {
      					$('#inputGrade').after('<small class="error errmess">Grade Level is required</small>');
      				}
      				if (section == 0) {
      					$('#inputSection').after('<small class="error errmess">Section is required</small>');
      				}
      				if (inputSY == 0) {
      					$('#inputSY').after('<small class="error errmess">School Year is required</small>');
      				}
      			}
            if($("#inputGender").val() == 'none'){
              proceed == 0;
              $("#inputGender").after("<small class='error errmess'>Gender is required</small>");
            }
            if($("#inputBdate").val() == ''){
              proceed == 0;
              $("#inputBdate").after("<small class='error errmess'>Birthdate is required</small>");
            }
      				 if($("#inputBarangay").val() == ''){
      					proceed = 0;
      					$("#inputBarangay").after("<small class='error errmess'>Barangay is required</small>");
      				 }
      				 if($("#inputMunCity").val() == null){
      					proceed = 0;
      					$("#inputMunCity").after("<small class='error errmess'>Municipality is required</small>");
      				 }
      				 if($("#inputProvince").val() == ''){
      					proceed = 0;
      					$("#inputProvince").after("<small class='error errmess'>Province is required</small>");
      				 }
      				 if($("#inputPostal").val() == ''){
      					proceed = 0;
      					$("#inputPostal").after("<small class='error errmess'>Postal is required</small>");
      				 }
      			if(proceed == 1) {
