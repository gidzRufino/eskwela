...
<div class="row">
    <ul class="nav nav-tabs" role="tablist" id="profile_tab">
        ...
        <li class="pull-right pointer"><a onclick="imgSignUpload(this.id)" id="fetcher" >Upload Fetcher's Image</a></li>
        ...
        <div style="padding-top: 15px;" class="tab-pane active" id="PersonalInfo">
            <div class="row">
                <div class="col-md-4 pull-right">
                    ...
                    if ($students->u_id != ""):echo base_url() . 'uploads/fetcherImg/' . $students->u_id . '.png';
                    else:echo base_url() . 'uploads/noImage.png';
                    endif;
                    ?>" />
                </div>
                    ...
                    <dl class="dl-horizontal">
                        ...
                        <dd>
                            ...
                            data-content=" 
                                 ...
                                 <input type='text' id='addmothertongue' />
                                 <div style='margin:5px 0;'>
                                 <button data-dismiss='clickover' class='btn btn-small btn-danger pull-right'>Cancel</button>&nbsp;&nbsp;
                                 <a href='#' id='mothertongue' data-dismiss='clickover' table='mothertongue' column='mothertongue' pk='rel_id' retrieve='getMothertongue' onclick='saveNewValue(this.id)' style='margin-right:10px;' class='btn btn-small btn-success pull-right'>Save</a></div>
                                 </div>
                                  "   
                    ...
                    <dl class="dl-horizontal">
                        ...
                        <dd>
                            ...
                            <i style="font-size:15px; color:#777;" class="fa fa-pencil-square-o clickover pointer <?php echo $editable ?>"
                               ...
                               <div style='margin:5px 0;'>
                               <button data-dismiss='clickover' class='btn btn-small btn-danger pull-right'>Cancel</button>&nbsp;&nbsp;
                               <a href='#' id='ethnicgroup' data-dismiss='clickover' table='ethnic_group' column='ethnic_group' pk='ethnic_group_id' retrieve='getEthnicGroup' onclick='saveNewValue(this.id)' style='margin-right:10px;' class='btn btn-small btn-success pull-right'>Save</a></div>
                               </div>
                               "   
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span title="double click to edit" id="a_fname" ><?php
                            if ($f->lastname != ""):echo $f->firstname . ' ' . $f->lastname;
                            else: echo "[empty]";
                            endif;
                            ?> </span>
                        <small>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span title="double click to edit" id="a_f_office_name" ><?php
                            if ($f->f_office_name != ""):echo $f->f_office_name;
                            else: echo "[empty]";
                            endif;
                            ?></span>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span title="double click to edit" id="a_mname" ondblclick="$('#a_mname').hide(), $('#mname').show(), $('#mname').focus()" ><?php
                            if ($m->lastname != ""):echo $m->firstname . ' ' . $m->lastname;
                            else: echo "[empty]";
                            endif;
                            ?> </span>
                        <small>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        ...
                        <input style="display: none; width:250px" type="text" id="m_occupation" value="<?php echo $m->occupation; ?>" 
                               onkeypress="if (event.keyCode == 13) {
                                           updateOccupation(this.value, '<?php echo $m->mid; ?>', 'm')
                                       }"
                               title="press enter to save your edit"
                               />
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span title="double click to edit" id="a_m_office_name" ><?php
                            if ($students->m_office_name != ""):echo $students->m_office_name;
                            else: echo "[empty]";
                            endif;
                            ?></span>
                ...
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        <span title="double click to edit" id="a_ice_name" ><?php
                            if ($students->ice_name != ""):echo $students->ice_name;
                            else: echo "[empty]";
                            endif;
                            ?></span>
