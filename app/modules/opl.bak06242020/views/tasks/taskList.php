    ...
    foreach ($tasks as $pd):
        ...
        ?>
                <tr style="cursor:pointer" >
                    ...
                    <td onclick="document.location='<?php echo base_url('opl/viewTaskDetails/'.$pd->task_auto_id.'/'.$pd->task_grade_id.'/'.$pd->task_section_id.'/'.$pd->task_subject_id)?>'"><?php echo $pd->task_title ?></td>
