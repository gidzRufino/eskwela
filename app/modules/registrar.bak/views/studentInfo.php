            ...
            <div class="col-lg-6" style="padding-left: 0;">
                <dl class="dl-horizontal">
                    ...
                    <dd>
                        ...
                        <i id="saveIce_nameBtn" onclick="updateProfile('<?php echo base64_encode('p_id') ?>', '<?php echo base64_encode('esk_profile_parent') ?>',<?php echo $students->p_id ?>, 'ice_name', $('#ice_name').val(), 'ice_name'), $('#a_ice_name').show(), $('#ice_name').hide(), $('#editIce_nameBtn').show(), $('#saveIce_nameBtn').hide(), $('#closeIce_nameBtn').hide()" style="font-size:15px; display: none; " class="fa fa-save clickover pointer"></i>
...
//            alert(grade_level + ' ' + section + ' ' + subject);
            ...
            if (grade_level == 0 || section == 0 || subject == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: 'st_id=' + stid + '&level=' + grade_level + '&section=' + section + '&subject=' + subject + '&csrf_test_name=' + $.cookie('csrf_cookie_name'),
                    success: function (data) {
