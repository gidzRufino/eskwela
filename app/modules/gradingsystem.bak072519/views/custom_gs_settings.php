<div class="row" >
    <div class="col-lg-12">
        <h3 class="page-header" style="margin:10px">Grading System Settings 
        </h3>
    </div> 
</div>
<?php
...
<div class="row" id="gs_settings_body">
    ...
    <div id="DO_8" class="<?php echo $do_8 ?> col-lg-12">
        <div class="col-lg-8">
            <div class="panel panel-green">
                ...
                <div class="panel-body">
                    <p>Raw score are being transmuted this way:<br />
                       <br />
                       <b>Transmuted Grade</b> = ((Learner's Total RS / Highest Possible Score) * 60 + 40);
                    </p>
                </div>
            </div>
                        ...
                        <div id="DO_Container1">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <th>Subjects</th>
                                    <?php
                                        $do_8settings = Modules::run('gradingsystem/getDO_settings',1);
                                    foreach ($do_8settings as $ds):
                                        ?>
                                        <th><?php echo $ds->category_name ?></th>
                                    <?php
                                    endforeach;
                                    ?>
                                </tr>
                                ...
                                <tr>
                                    <td><?php echo $ds->subject ?></td>
                                    <?php 
                                    
                                    foreach ($do_settings as $subDS): ?>
                                    <td sub_id="<?php echo $subDS->subject_id; ?>"><?php echo ($subDS->weight*100).'%' ?></td>
                                    <?php endforeach; ?>
                                </tr>
                                <?php
                                    endforeach;
...
<?php 
$data['do_8settings'] = $do_8settings;
$this->load->view('custom_addWeights_modal', $data); ?>
