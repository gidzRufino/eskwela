         ...
         <div class="panel-body">
             <div class="col-lg-12">
                ...
                <div class="well col-lg-12 no-padding">
                    ...
                    $cashReg['penCharges'] = Modules::run('finance/finance_lma/getPenalty',base64_decode($st_id), 0, $student->school_year);
                    $this->load->view('lma_cashRegister', $cashReg) ?>
                </div>    
             </div>
         </div>
     </div>
...
<script type="text/javascript">
    ...
    function cash_change()
    {
        ...
        tot_change = number2string(calc_change.toFixed(2));
    ...
    function saveTransaction()
    {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url() . 'finance/finance_lma/saveTransaction' ?>',
            //dataType: 'json',
            data: {
