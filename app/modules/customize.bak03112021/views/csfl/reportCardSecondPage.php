...
$pdf->MultiCell(10, 5, ($aveFirst != 0 ? $aveFirst : ''), 1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(10, 5, ($aveSecond != 0 ? $aveSecond : ''), 1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(10, 5, ($aveThird != 0 ? $aveThird : ''), 1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(10, 5, ($aveFourth != 0 ? $aveFourth : ''), 1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
$pdf->MultiCell(11, 5, ($aveFinRate != 0 ? $aveFinRate : ''), 1, 'C', 0, 0, '', '', true, 0, false, true, 5, 'M');
...
$pdf->Image($gLegend, 15, 90, 120, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
$pdf->Ln(30);
