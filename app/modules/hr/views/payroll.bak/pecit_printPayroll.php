	...
	public function Header() {
		// Logo
                ...
                if($this->page==1):
                    ...
                    $this->Image($image_file, 23, 6, 15, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
                    $this->Ln(10);
                    $this->SetFont('helvetica', 'B', 12);
...
$pdf->MultiCell(70, 10, 'NAME OF EMPLOYEE',1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->MultiCell(50, 10, 'POSITION',1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->MultiCell(30, 10, 'BASIC PAY',1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
        foreach($charges as $deductions): 
            $pdf->MultiCell($columnWidth, 10, strtoupper($deductions->pi_item_name),1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
        endforeach;

$pdf->MultiCell($fixedWidth, 10, 'OTHER DEDUCTIONS',1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->MultiCell($fixedWidth, 10, 'TOTAL DEDUCTIONS',1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->MultiCell($fixedWidth, 10, 'NET PAY',1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->Ln();
...
foreach($getPayrollReport as $pr):
        ...
        if($pr->salary!=0):   
            ...
            $pdf->SetX(5);
            $pdf->MultiCell(10, 10, $i,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
            $pdf->MultiCell(70, 10, $pr->firstname.' '.$pr->lastname,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
            $pdf->MultiCell(50, 10, $pr->position,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
            $pdf->MultiCell(30, 10, $salary,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
                $totalStat= 0;
            $addOn = 0;
            $totalNetPayroll = 0;
            $items = 1;
            ...
            foreach($charges as $deductions): 
                ...
                $pdf->MultiCell($columnWidth, 10, $amount,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
        ...
        $pdf->MultiCell($fixedWidth, 10, $totalDeductibleTardy,1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
        $pdf->MultiCell($fixedWidth, 10, number_format(($totalDeductibleTardy+$totalStat), 2, '.', ','),1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
        $pdf->MultiCell($fixedWidth, 10, number_format((($netpay+$addOn)-($totalDeductibleTardy+$totalStat)), 2, '.', ','),1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
        $pdf->Ln();   
       $i++;    
...
// set cell padding
$pdf->SetX(5);
$pdf->MultiCell(130, 10, 'TOTAL',1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->MultiCell(30, 10, number_format($totalNetPay, 2, '.',','),1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
        ...
        foreach($charges as $deductions): 
            ...
            $pdf->MultiCell($columnWidth, 10,number_format($amount,2,'.',','),1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
            
        endforeach;

$pdf->MultiCell($fixedWidth, 10, number_format($totalTardy,2,'.',','),1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->MultiCell($fixedWidth, 10, number_format($totalOD,2,'.',','),1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->MultiCell($fixedWidth, 10, number_format($totalNetPayroll,2,'.',','),1, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
$pdf->Ln();
