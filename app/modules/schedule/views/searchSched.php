<table class="table table-bordered table-hover">
    <thead>
        <tr>
            <th class="text-center" colspan="7"><h3 class="no-padding"><?php $teacher = Modules::run('hr/getEmployeeName', $teacher_id); echo $teacher->lastname.', '.$teacher->firstname; ?></h3></th>
        </tr>
        <tr>
                    ...
                    <tr>
                        ...
                        <?php   
                            ...
                            for($d=1;$d<=6;$d++):
                                ...
                                $timeSched = Modules::run('schedule/getAllSchedule', $t->time_fr, $t->time_to, $d, $teacher_id);
                                if($d == $s->day):
